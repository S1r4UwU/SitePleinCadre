  ...
  return (
    <>
      <PageHeader
        ...
        intro={
          <p>
            Pour une question sur une session, sur votre éligibilité à un financement ou sur
            votre candidature : le téléphone reste le plus rapide.
          </p>
        }
      />
              ...
              <div className="mt-5 space-y-8">
                <div className="border-t border-ink/15 pt-6">
                  ...
                  <p className="mt-3 text-sm text-ink-mute">
                    C'est ici que se déroulent les stages. Métro Croix-Paquet ou
                    Hôtel de Ville, pentes de la Croix-Rousse.
                  </p>
                </div>

                <div className="border-t border-ink/15 pt-6">
                  <h3 className="font-[family-name:var(--font-display)] text-2xl">Paris</h3>
                  <address className="mt-2 not-italic text-ink-soft">
          ...
          <div className="grid gap-8 lg:grid-cols-12">
            <div className="lg:col-span-7">
              ...
              <p className="measure mt-5 text-ink-soft">
                Passez directement par le formulaire de candidature : il nous transmet tout
                ce dont nous avons besoin pour vous répondre et préparer votre dossier de
                financement.
              </p>
            </div>
