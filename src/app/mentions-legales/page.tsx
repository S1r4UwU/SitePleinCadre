        ...
        <Container>
          <Prose>
            <p>
              ...
              {" "}{site.nomComplet} l'identité des différents intervenants dans le cadre de
              sa réalisation et de son suivi.
            </p>

            <h2>Édition du site</h2>
            <p>
              Le présent site, accessible à l'URL pleincadre-formation.com (le « Site »), est
              édité par : <strong>{site.legal.raisonSociale}</strong>, société au capital de{" "}
              {site.legal.capital}, inscrite au R.C.S. de Lyon sous le numéro{" "}
            ...
            {site.legal.numeroDeclarationActivite && (
              <p>
                Déclaration d'activité de prestataire de formation enregistrée sous le numéro{" "}
                {site.legal.numeroDeclarationActivite} auprès du préfet de région
                Auvergne-Rhône-Alpes. Cet enregistrement ne vaut pas agrément de l'État.
              </p>
            )}

            <h2>Directrice de la publication</h2>
            <p>La directrice de la publication du Site est {site.legal.directricePublication}.</p>
            ...
            <p>
              ...
              {site.qualiopi.categorie} ». La certification qualité a été délivrée au titre
              de cette catégorie d'action.
            </p>
            ...
            <p>
              L'ensemble des contenus présents sur le Site (textes, programmes de formation,
              images, identité visuelle) est la propriété de {site.legal.raisonSociale}, sauf
              mention contraire. Toute reproduction ou représentation, totale ou partielle,
